/**
 * Migrações do banco (PostgreSQL). Cada item é aplicado uma única vez e
 * registrado em schema_migrations. Para adicionar mudanças, acrescente um
 * novo item ao final — nunca edite migrações já publicadas.
 *
 * `npm run db:schema` exporta o SQL consolidado para database/schema.sql.
 */
...
export const ALL_TABLES = [
  'activities', 'achievements_unlocked', 'notifications', 'game_players', 'games', 'room_viewers',
  'room_members', 'rooms', 'club_members', 'clubs', 'transactions', 'wallets', 'users', 'settings',
];
